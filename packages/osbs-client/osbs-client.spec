...
BuildRequires:  python3-opentelemetry_api
BuildRequires:  python3-opentelemetry_sdk
BuildRequires:  python3-opentelemetry_instrumentation_requests
BuildRequires:  python3-opentelemetry_exporter_otlp
BuildRequires:  python3-otel_extensions
%endif # with_check
...
Requires:       git-core
Requires:       python3-opentelemetry_api
Requires:       python3-opentelemetry_sdk
Requires:       python3-opentelemetry_instrumentation_requests
Requires:       python3-opentelemetry_exporter_otlp
Requires:       python3-otel_extensions
...
%changelog
* Tue Sep 26 2023 Harsh Modi <rcerven@redhat.com> 2.6.0-1
