...
# for BREW, release format is as follows: INTERNALVERSION.RELEASE
# see: https://projects.engineering.redhat.com/browse/BREW-544
%if "x%{?testbuild}" == "x1"
...
%changelog
* Tue Sep  5 2023  Tomas Kopecek <tkopecek at redhat.com> - 1.33.0-6
- PR#3893: Clean rpm db directory of broken symlinks

* Thu Jun 29 2023  Tomas Kopecek <tkopecek at redhat.com> - 1.33.0-5
- PR#3859:  Fix user_in_group policy test, additional fix

* Wed Jun 28 2023  Tomas Kopecek <tkopecek at redhat.com> - 1.33.0-4
- PR#3859:  Fix user_in_group policy test

* Tue Jun 27 2023  Tomas Kopecek <tkopecek at redhat.com> - 1.33.0-3
- PR#3857: Fix duplicate build link on CG taskinfo page

* Mon Jun 19 2023  Tomas Kopecek <tkopecek at redhat.com> - 1.33.0-2
- INTERNAL: Disable ssl verify for image tasks
